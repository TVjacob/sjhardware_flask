...
const submitPayment = async () => {
  console.log("props.sale ",props.sale)
  console.log("sale_id ",props.sale.sale_id)

  if (!props.sale || !props.sale.sale_id) return;
  ...
  try {
    ...
    console.error('Error saving payment:', err.ressalense?.data || err.message);
  }
};
